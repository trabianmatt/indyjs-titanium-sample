# Now: button.view.addEventListener just feels wrong.
...
# Done! Well, that looks better. Also, quite similar to
# node_modules/titanium-backbone-ks/src/ks/views/intro.coffee
#
